...
public class NUSModsUtil {
    ...
    private final static String MODULE_LIST_URL = "https://api.nusmods.com/v2/%d-%d/modules/%s.json";
    private final static String MODULE_URL = "https://api.nusmods.com/v2/%d-%d/moduleList.json";
