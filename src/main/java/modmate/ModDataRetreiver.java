...
public class ModDataRetreiver {
    ...
    /**
     * Returns a list of sample mods with their details such as mod code, name, description, and prerequisites.
     * The mods are manually created for demonstration purposes.
     *
